const watch = (
  <svg width={72} height={72} viewBox="0 0 72 72" fill="none">
    ...
    <defs>
      ...
      >
        <stop offset="0.307292" stopColor="#F89DC6" />
        <stop offset="0.645392" stopColor="#E75094" />
        <stop offset={1} stopColor="#59216E" />
      </radialGradient>
      <radialGradient
      ...
      >
        <stop stopColor="#FFA984" />
        <stop offset={1} stopColor="#F7636B" stopOpacity={0} />
      </radialGradient>
      <linearGradient
